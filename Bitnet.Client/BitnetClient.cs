...
namespace Bitnet.Client
{
    public class BitnetClient : IBitnetClient
    {
        ...
        /// </summary>
        /// <param name="rawtx"><hex string></param>
        /// <returns></returns>
        public JObject DecodeRawTransaction(string rawtx)
        {
            return InvokeMethod("decoderawtransaction", rawtx)["result"] as JObject;
        }

        /// <summary>
        /// version 0.7 Returns raw transaction representation for given transaction id.
        /// </summary>
        /// <param name="rawtx"><txid></param>
        /// <param name="verbose"></param>
        /// <returns></returns>
        public JObject GetRawTransaction(string rawtx)
        {
            return InvokeMethod("getrawtransaction", rawtx, 1)["result"] as JObject;
        }
        ...
        {
            return (string)InvokeMethod("getblockhash", index)["result"];
        }
    }
}
